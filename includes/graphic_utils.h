...
class GraphicUtils {
  public:
    static void triangle(Display* display, uint16_t x0, uint16_t y0, uint16_t x1,
    ...
    static void filled_triangle(Display* display, uint16_t x0, uint16_t y0, uint16_t x1,
        uint16_t y1, uint16_t x2, uint16_t y2, Color color) {
